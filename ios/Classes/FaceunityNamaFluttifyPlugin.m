...
@implementation FaceunityNamaFluttifyPlugin {
...
+ (void)registerWithRegistrar:(NSObject <FlutterPluginRegistrar> *)registrar {
  FlutterMethodChannel *channel = [FlutterMethodChannel
      methodChannelWithName:@"com.fluttify/faceunity_nama_fluttify"
            binaryMessenger:[registrar messenger]];

  [registrar addMethodCallDelegate:[[FaceunityNamaFluttifyPlugin alloc] initWithFlutterPluginRegistrar:registrar]
                           channel:channel];
