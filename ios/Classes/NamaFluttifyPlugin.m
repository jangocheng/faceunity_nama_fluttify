...
@implementation NamaFluttifyPlugin {
...
+ (void)registerWithRegistrar:(NSObject <FlutterPluginRegistrar> *)registrar {
  FlutterMethodChannel *channel = [FlutterMethodChannel
      methodChannelWithName:@"com.fluttify/nama_fluttify"
            binaryMessenger:[registrar messenger]];

  [registrar addMethodCallDelegate:[[NamaFluttifyPlugin alloc] initWithFlutterPluginRegistrar:registrar]
                           channel:channel];
